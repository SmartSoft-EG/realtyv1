...
<template>
    <d-page @refresh="str.fetchRealty()"><template #tools>
        ...
        <v-alert color="primary" icon="" :value="true">

        </v-alert>
        <a-dialog v-model="str.show_add_dialog" title="Add reservation" @save="saveReservation()">
            {{ realty_reservation.realty_unit_id }}
            <a-form-item label="unit" validation>
                <a-select allowClear placeholder="select unit" :show-arrow="false" :not-found-content="null" show-search
