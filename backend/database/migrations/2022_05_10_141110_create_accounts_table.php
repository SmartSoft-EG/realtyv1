...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        //
        DB::table('accounts')->insert(['id' => 22701, 'name' => 'ايراد الوحدات', 'level' => 5, 'parent_id' => 227, 'is_main' => 0, 'debit_or_credit' => 'credit']);
        ...
        DB::table('accounts')->insert(['id' => 1125, 'name' => 'الصناديق', 'level' => 4, 'parent_id' => 112, 'is_main' => 1]);
        DB::table('accounts')->insert(['id' => 1127, 'name' => 'العملاء', 'level' => 4, 'parent_id' => 112, 'is_main' => 0]);
        ...
        DB::table('accounts')->insert(['id' => 1239, 'name' => 'الموردين', 'level' => 4, 'parent_id' => 123, 'is_main' => 0]);
        ...
        DB::table('accounts')->insert(['id' => 12412, 'name' => 'جاري الشركاء', 'level' => 4, 'parent_id' => 124, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 124181, 'name' => 'الارباح والخسائـر', 'level' => 4, 'parent_id' => 124, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 12513, 'name' => 'مخصص ديون مشكوك فيها', 'level' => 4, 'parent_id' => 125, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 12514, 'name' => 'ارباح وخسائر', 'level' => 4, 'parent_id' => 125, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 126161, 'name' => 'اجور مستحقة', 'level' => 4, 'parent_id' => 126, 'is_main' => 0]);
        ...
        DB::table('accounts')->insert(['id' => 211020, 'name' => 'الرواتب', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211021, 'name' => 'بدل انتقال وبنزين', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211022, 'name' => 'قرطاسية ومطبوعات', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211023, 'name' => 'خصم مسموح به', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211024, 'name' => 'صيانة سيارات', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211025, 'name' => 'صيانة اجهزة المكتب', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);

        DB::table('accounts')->insert(['id' => 211026, 'name' => 'مصروفات متنوعة', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211027, 'name' => 'مصروفات توزيع', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211028, 'name' => 'مصروفات تاسيس', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211029, 'name' => 'مصروفات طباعة', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211030, 'name' => 'مصروفات تصميم', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211031, 'name' => 'مصروفات بوفية', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211032, 'name' => 'مصروفات تليفون وبرق وهاتف', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211033, 'name' => 'رسوم واشتراكات', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        DB::table('accounts')->insert(['id' => 211034, 'name' => 'مصروفات دعاية ونشر', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
        ...
        DB::table('accounts')->insert(['id' => 211037, 'name' => 'مصروفات نثرية', 'level' => 4, 'parent_id' => 2110, 'is_main' => 0]);
